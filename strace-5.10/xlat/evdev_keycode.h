...
#endif
#if defined(KEY_NOTIFICATION_CENTER) || (defined(HAVE_DECL_KEY_NOTIFICATION_CENTER) && HAVE_DECL_KEY_NOTIFICATION_CENTER)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((KEY_NOTIFICATION_CENTER) == (0x1bc), "KEY_NOTIFICATION_CENTER != 0x1bc");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define KEY_NOTIFICATION_CENTER 0x1bc
#endif
#if defined(KEY_PICKUP_PHONE) || (defined(HAVE_DECL_KEY_PICKUP_PHONE) && HAVE_DECL_KEY_PICKUP_PHONE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((KEY_PICKUP_PHONE) == (0x1bd), "KEY_PICKUP_PHONE != 0x1bd");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define KEY_PICKUP_PHONE 0x1bd
#endif
#if defined(KEY_HANGUP_PHONE) || (defined(HAVE_DECL_KEY_HANGUP_PHONE) && HAVE_DECL_KEY_HANGUP_PHONE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((KEY_HANGUP_PHONE) == (0x1be), "KEY_HANGUP_PHONE != 0x1be");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#endif
#if defined(KEY_FN_RIGHT_SHIFT) || (defined(HAVE_DECL_KEY_FN_RIGHT_SHIFT) && HAVE_DECL_KEY_FN_RIGHT_SHIFT)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((KEY_FN_RIGHT_SHIFT) == (0x1e5), "KEY_FN_RIGHT_SHIFT != 0x1e5");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
