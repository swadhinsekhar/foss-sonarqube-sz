...
#endif
#if defined(IORING_REGISTER_RESTRICTIONS) || (defined(HAVE_DECL_IORING_REGISTER_RESTRICTIONS) && HAVE_DECL_IORING_REGISTER_RESTRICTIONS)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((IORING_REGISTER_RESTRICTIONS) == (11U), "IORING_REGISTER_RESTRICTIONS != 11U");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define IORING_REGISTER_RESTRICTIONS 11U
#endif
#if defined(IORING_REGISTER_ENABLE_RINGS) || (defined(HAVE_DECL_IORING_REGISTER_ENABLE_RINGS) && HAVE_DECL_IORING_REGISTER_ENABLE_RINGS)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((IORING_REGISTER_ENABLE_RINGS) == (12U), "IORING_REGISTER_ENABLE_RINGS != 12U");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
